        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="group relative p-6 sm:p-7 rounded-2xl border border-zinc-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/60 hover:border-[#FA5D29]/40 hover:shadow-xl hover:shadow-[#FA5D29]/5 hover:-translate-y-1 transition-all duration-300 cursor-default"
              >
                {/* Top Row */}
                <div className="flex items-center justify-between mb-4">
                  <div className="size-11 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-[#FA5D29] flex items-center justify-center group-hover:bg-[#FA5D29]/10 transition-colors">
                ...
                <h3 className="font-bold text-lg tracking-tight text-zinc-900 dark:text-white mb-2 group-hover:text-[#FA5D29] transition-colors">
                  {feature.title}
                </h3>
